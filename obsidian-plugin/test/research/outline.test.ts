...
const records: ResearchRecord[] = [
  ...
  { path: "Research/P/Evidence/Context.md", title: "Context", type: "evidence", project: "Research/P/Project.md", source: "Research/P/Sources/S.md", locatorKind: "paragraph", locatorValue: "3", excerpt: "Contextual excerpt.", reviewState: "reviewed" },
