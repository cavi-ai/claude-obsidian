...
export interface ScholarlyIdentityFields {
  doi?: string;
  arxivId?: string;
  zoteroKey?: string;
  authors?: string[];
...
export type IdentifiableResearchSource = ResearchSourceRecord & ScholarlyIdentityFields;
...
export function canonicalSourceId(
  source: Pick<ResearchSourceRecord, "canonicalId" | "url"> & Pick<ScholarlyIdentityFields, "doi" | "arxivId" | "zoteroKey">,
): string | undefined {
...
const stableValue = (source: IdentifiableResearchSource, key: StableKey): string | undefined => {
...
function hasStableConflict(left: IdentifiableResearchSource, right: IdentifiableResearchSource): boolean {
...
function bibliographyFingerprint(source: IdentifiableResearchSource): string | undefined {
...
export function findDuplicate<T extends IdentifiableResearchSource>(candidate: T, existing: readonly T[]): T | undefined {
