...
- **`discovery/`** — scholarly discovery (OpenAlex/Crossref/arXiv adapters) with provenance, deterministic + model reranking, and deliberate import into the research library. External requests only fire on explicit Search.
